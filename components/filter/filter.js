...
const Filter = () => {
  return (
    <section className="flex p-[5vw] sm:px-5 md:px-12 lg:px-20 xl:px-32 sm:pb-10 sm:pt-36">
      <div className="w-1/4 bg-white p-4 me-4 rounded-lg shadow-lg">
      ...
      <div className="w-3/4 flex flex-wrap ms-">

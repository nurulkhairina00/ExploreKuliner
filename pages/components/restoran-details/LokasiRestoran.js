  ...
  return (
    <div className="w-full lg:w-1/3 xl:w-1/4 mt-4 lg:mt-0">
      <div className=" bg-white rounded-lg shadow-lg p-[2.5vw] sm:p-4">
        ...
        <div className="bg-gray rounded-lg shadow-lg h-[38vw] sm:h-52"></div>
        <div className="text-black pt-[3vw] sm:pt-5">
          <p className="text-[3vw] sm:text-base font-semibold pb-[1vw] sm:pb-2">
            Jam Operasional
          </p>
                ...
                return (
                  <div className="w-full flex" key={index}>
                    <div className="w-1/4 pb-[1vw] sm:pb-1">
                      <p className="text-[2.5vw] sm:text-sm">{item.hari}</p>
                    </div>
                    <div className="w-3/4 pb-[1vw] sm:pb-1">
                      <p className="text-[2.5vw] sm:text-sm">{item.jam}</p>
                    </div>
                  </div>
                );
              })}

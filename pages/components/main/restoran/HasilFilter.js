...
const HasilFilter = () => {
  ...
  return (
    <div className="w-full xl:w-3/4 sm:px-4 relative pb-[20vw] sm:pb-28 mt-[-29vw] sm:mt-[-160px] xl:mt-0">
          ...
          <Link href={`/restoran/detail/${item.id}`} key={item.id}>
            <div className="flex flex-row shadow-md hover:shadow-xl rounded-[2vw] sm:rounded-lg">
              ...
              <div className="w-2/3 p-[2vw] sm:px-4 sm:py-2">
                <p className="text-black text-[3.5vw] sm:text-lg font-semibold sm:pb-1">
                  {item.nama_resto}
                </p>
                <div className="flex">
                  <Rating initialRating={item.rating} />
                </div>
                <p className="text-black text-[3vw] sm:text-base font-semibold py-[1vw] sm:py-2">
                  Asia Indonesia
                </p>
                <p className="text-secondary text-[3vw] sm:text-base font-bold ">
                  Restoran Buka
                </p>
                <p className="text-gray text-[3vw] sm:text-base font-semibold sm:py-1">
                  Sampai 22.00 WIB
                </p>

    ...
    <section className="bg-black p-[5vw] sm:px-5 md:px-12 lg:px-20 xl:px-32 sm:py-10">
      ...
      <div className="flex flex-wrap gap-[3vw] sm:gap-8 justify-center items-center sm:item-start sm:justify-start py-[2vw] sm:py-4">
        <Link href="/tentang-kami">
          <a className="text-[3vw] sm:text-base text-white">Tentang Kami</a>
        </Link>
        <Link href="/syarat-dan-ketentuan">
          <a className="text-[3vw] sm:text-base text-white">
            Syarat dan Ketentuan
          </a>
        </Link>
        <Link href="/faq">
          <a className="text-[3vw] sm:text-base text-white">Faq</a>
        </Link>
        <Link href="/hubungi-kami">
          <a className="text-[3vw] sm:text-base text-white">Hubungi Kami</a>
        </Link>
      </div>

      <p className="text-white text-center text-[2.5vw] sm:text-sm sm:text-start font-semibold">

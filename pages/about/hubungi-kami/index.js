            ...
            <form action="">
              ...
              <div className="pb-[2vw] sm:pb-4">
                ...
                <textarea
                  ...
                  className="w-full rounded-[2vw] sm:rounded-lg sm:mt-2 p-[3vw] sm:p-3 text-[3.5vw] sm:text-base bg-primary border-mediumGray border-2 focus:border-none"
                />
              </div>
              <div className="flex justify-center items-center pt-[2vw] sm:pt-4">
                <button
                  type="submit"
                  className=" font-bold text-white px-[4vw] py-[1.5vw] sm:px-6 sm:py-2 rounded-[2vw] sm:rounded-lg bg-secondary text-[3.5vw] sm:text-lg"
                >
                  Kirim
                </button>
              </div>
